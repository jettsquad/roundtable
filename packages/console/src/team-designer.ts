...
const TEAM_PLAN_RULES = [
  ...
  "- 需要联网查资料的席位，把 webAccess 设为 true；claude-code 和 codex 都可以，dsh 本来就能上网。",
  ...
  seats: [
    ...
    },
    {
      ...
      systemPrompt: say(
        ...
        "   把 webAccess 设成 true。claude-code 走 WebFetch / WebSearch，codex 走 bash + curl，两个都行。",
        "   **不勾 webAccess 又让它查资料，它会凭记忆编出来**——该勾的一定要勾上。",
        "",
